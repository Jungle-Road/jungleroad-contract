...
export interface JungleRoadTokenInterface extends utils.Interface {
  functions: {
...
export interface JungleRoadToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: JungleRoadTokenInterface;
